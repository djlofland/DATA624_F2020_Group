...
Based on evaluating both RMSE and $R^2$, our Gradient Boosted Model (GBM) out performed the other models.  This is not surprising as GBM models are more tolerant of multicollinearity and better account for non-linear features. 
