...
#### Model \#7 Multivariate Adaptive Regression Splines (MARS)

##### *(Kera Deep Learning NN). This might be a redundant method to Model \#4. I chose MARS to replace the original choosing of Kera Neural Network in Kera.*
